...
export default function LatestJobCards({job}) {
  ...
  return (
    <div onClick={()=> navigate(`/description/${job._id}`)} className="p-5 rounded-md shadow-xl bg-white border-gray-100 cursor-pointer hover:shadow-2xl transition-all duration-300">
      <div>
